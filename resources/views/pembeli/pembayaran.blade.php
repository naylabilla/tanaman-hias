    ...
    <div class="container mx-8">
        @if ($resi->alamat != null)
            <div class="flex justify-between items-start mb-2">
                ...
                <a href="/alamat/{{ $resi->id }}"
                    class="btn bg-[#00A651] border-none mt-3 w-44 text-xl text-white mb-5">Ubah</a>
            </div>
        ...
        @else
            ...
            <a href="/alamat/{{ $resi->id }}"
                class="btn bg-[#00A651] border-none mt-3 w-44 text-xl text-white mb-5">Tambah Alamat</a>
        ...
        @foreach ($resi->pesanan as $item)
            <div class="grid grid-cols-5 my-5">
                <div class="w-48 rounded-xl ml-10">
                    <img src="{{ asset('assets/images/outdoor/gambar 5 monstera.png') }}" alt="">
                </div>
            ...
            <div class="grid grid-cols-5 my-5">
                <div class="col-span-2">
                    ...
                    <select name="metode_pembayaran" id=""
                        class="w-4/6 h-10 text-2xl bg-white text-black border border-4 border-green-400">
                ...
                <div class="col-span-3">
                    ...
                    <textarea class="w-full bg-white text-black resize-none border border-4 border-green-400" name="pesan" id=""
                        rows="3"></textarea>
                </div>
            </div>
            <div class="grid grid-cols-2 items-center">
                <a href="" class="text-2xl text-black font-bold">
                    <img src="{{ asset('assets/icons/kembali.png') }}" alt=""
                        class="inline size-5 mb-1 ml-1">Kembali
                </a>
