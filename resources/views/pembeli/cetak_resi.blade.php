...
<body class="bg-[#f8fafc] h-screen">
    <div class="mt-14">
        <div class="border border-black w-5/6 mx-auto p-5">
            <div class="relative h-10 flex items-center">
                <img src="./assets/icons/icon toko.png" alt="" class="absolute left-0 h-full">
                <h1 class="text-xl ml-12 -mt-2">Lustilvy</h1>
