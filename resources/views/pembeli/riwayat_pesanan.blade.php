...
<body class="h-full pb-5" style="background-image: url('assets/images/tamu/bg.png'); background-size: contain; background-position: center;">
    <!-- Navbar -->
...
<hr class="border-black mx-24 my-2" style="width: calc(100% - 123px);" />
    ...
    <div class="grid grid-cols-1 grid-flow-row gap-0 border-2 border-black w-5/6 mx-auto mb-10">
        <div class="h-20 flex justify-center border text-left text-black pl-2 flex-col relative">
            ...
            <button class="absolute top-6 right-44 rounded bg-[#00A651] bg-hover">
            ...
            <a href="{{ route('rekapan.resi_pembeli', $pesananGroup->first()->resi_id) }}" target="_blank" class="bg-[#00A651] text-black font-bold px-8 py-1 rounded absolute top-6 right-3 no-print">Cetak Resi</a>
        ...
        <div class="relative">
            ...
            @endphp
            <div class="h-40 flex items-center border-t border-b border-black">
        ...
        <div class="h-14 flex justify-between border-t text-black pl-2 flex-col relative">
            <p class="text-lg font-bold absolute top-3 pl-2">Total Pesanan</p>
