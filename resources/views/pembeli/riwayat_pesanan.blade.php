...
<hr class="border-black mx-24 my-2" style="width: calc(100% - 123px);" />
    ...
    <div class="grid grid-cols-1 grid-flow-row gap-0 border-2 border-black w-5/6 mx-auto mb-10">
        <div class="h-20 flex justify-center border text-left text-black pl-2 flex-col relative">
            ...
            <a href="{{ route('rekapan.resi_pembeli', $pesananGroup->first()->resi_id) }}" class="bg-[#00A651] text-black font-bold px-8 py-1 rounded absolute top-6 right-3 no-print">Cetak Resi</a>
