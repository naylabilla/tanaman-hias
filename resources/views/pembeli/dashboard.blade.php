...
<html lang="en">
    ...
    <body class="bg-[#6D896B] h-full">
        ...
        >
            ...
            <div class="ms-auto">
                ...
                >
                    ...
                    <p class="text-2xl text-[#78A07C]">Profile</p>
                </a>
        ...
        >
            ...
            <template x-for="slide in slides" :key="slide.id">
                <div
                    ...
                    class="h-80 flex items-center rounded-lg overflow-hidden"
                >
                    <img
                        :src="slide.image"
                        alt="Slide Image"
            ...
            <div class="absolute inset-0 flex justify-between items-center">
                <button
                    ...
                    class="bg-slate-100 text-slate-500 hover:bg-red-500 hover:text-white transition font-bold rounded-full w-12 h-12 shadow text-center flex justify-center items-center -ml-16"
                >
                    <svg
                ...
                <button
                    ...
                    class="bg-slate-100 text-slate-500 hover:bg-red-500 hover:text-white transition font-bold rounded-full w-12 h-12 shadow text-center flex justify-center items-center -mr-16"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
        ...
        <div class="font-semibold pb-2 w-5/6 mx-auto text-center -mt-3">
            ...
            <div class="flex justify-center mt-1 px-2">
                <div class="ml-40 mr-auto text-center">
                    <!-- Untuk gambar 1 -->
                    <img
                        src="assets/images/tamu/service1.png"
                        alt="Gambar 1"
                ...
                <div class="mx-4 text-center">
                    <!-- Untuk gambar 2 -->
                    <img
                        src="assets/images/tamu/service2.png"
                        alt="Gambar 2"
                        class="w-32 h-32 object-cover"
                    />
                ...
                <div class="ml-auto mr-40 text-center">
                    <!-- Untuk gambar 3 -->
                    <img
                        src="assets/images/tamu/service3.png"
                        alt="Gambar 3"
                        class="w-32 h-32 object-cover"
                    />
        ...
        <div class="font-semibold pb-2 w-5/6 mx-auto text-center -mt-3">
            ...
            <div class="flex justify-center mt-2">
                <a href="#outdoor" class="ml-20 mr-auto text-center">
                    <!-- Untuk gambar 1 -->
                    <div
                        class="bg-gray-100 shadow-lg rounded-lg custom-card-size"
                    >
                        <img
                            src="assets/images/outdoor/gambar 9 goeppertia.png"
                            alt="Gambar 1"
                            class="w-64 h-64 mx-auto -mt-1 object-scale-down"
                        />
                    </div>
                ...
                <a href="#populer" class="mx-4 text-center">
                    ...
                    >
                        <img
                            src="assets/images/populer/gambar 1 monstera.png"
                            alt="Gambar 2"
                            class="w-64 h-64 mx-auto -mt-1 object-scale-down"
                        />
                    </div>
                ...
                <a href="#indoor" class="ml-auto mr-20 text-center"
                    ...
                    >
                        <img
                            src="assets/images/indoor/gambar 4 calla.png"
                            alt="Gambar 3"
                            class="w-64 h-64 mx-auto -mt-1 object-scale-down"
                        />
                    </div>
        ...
        <!-- Populer -->
        <div
            class="font-semibold pb-2 w-5/6 mx-auto text-center -mt-3"
            id="populer"
        >
            <div class="flex items-center justify-center">
                <div class="flex-1 h-0.5 bg-green-200"></div>
            ...
            <div class="px-2 mt-1">
                Saat ini kamu tertarik untuk menambah koleksi tanaman hias daun
                di
                <div class="px-2 mt-1">
                    rumah agar terlihat lebih asri, berikut 6 rekomendasi
                    tanaman hias
                    ...
                    <div class="grid grid-cols-3 gap-4 mt-4">
                        ...
                        <div class="text-center">
                            ...
                            <div class="bg-gray-100 shadow-lg rounded-lg p-4">
                                <img
                                    src="assets/images/populer/gambar 2 caladium.png"
                                    alt="Gambar 2"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                        ...
                        <div class="text-center">
                            ...
                            <div class="bg-gray-100 shadow-lg rounded-lg p-4">
                                <img
                                    src="assets/images/populer/gambar 3 maranta.png"
                                    alt="Gambar 3"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                        ...
                        <div class="text-center">
                            ...
                            <div class="bg-gray-100 shadow-lg rounded-lg p-4">
                                <img
                                    src="assets/images/populer/gambar 4 lavender.png"
                                    alt="Gambar 4"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                        ...
                        <div class="text-center">
                            ...
                            <div class="bg-gray-100 shadow-lg rounded-lg p-4">
                                <img
                                    src="assets/images/populer/gambar 5 spathyphillum.png"
                                    alt="Gambar 5"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                        ...
                        <div class="text-center">
                            ...
                            <div class="bg-gray-100 shadow-lg rounded-lg p-4">
                                <img
                                    src="assets/images/populer/gambar 6 watermelon.png"
                                    alt="Gambar 6"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
        ...
        >
            ...
            <div class="px-2 mt-1">
                Tanaman Hias Outdoor merupakan pilihan tepat untuk mempercantik
                <div class="px-2 mt-1">
                    halaman. Warna hijau dan wanginya bunga dapat memberi
                    kesegaran
                    ...
                    <div class="grid grid-cols-3 gap-4 mt-4">
                        <div class="text-center">
                            <!-- Untuk gambar 1 -->
                            <div
                                class="bg-gray-100 shadow-lg rounded-lg p-4 relative"
                            >
                                <img
                                    src="assets/icons/outdoor.png"
                                    alt="Icon"
                                    class="absolute w-20 h-20 -ml-4 -mt-3"
                                />
                                <img
                                    src="assets/images/outdoor/gambar 1 bromelia.png"
                                    alt="Gambar 1"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                                ...
                                <button
                                    class="absolute bottom-3 right-3 bg-green-400 bg-hover hover:bg-gray-300"
                                >
                                    <img
                                        src="assets/icons/icon keranjang.png"
                                        alt="Icon"
                        ...
                        <div class="text-center">
                            ...
                            >
                                ...
                                />
                                <img
                                    src="assets/images/outdoor/gambar 2 caladium.png"
                                    alt="Gambar 2"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                                <div class="mt-3 text-bold">
                        ...
                        <div class="text-center">
                            ...
                            >
                                ...
                                />
                                <img
                                    src="assets/images/outdoor/gambar 3 lavender.png"
                                    alt="Gambar 1"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                                <div class="mt-3 text-bold">
                        ...
                        <div class="text-center">
                            ...
                            >
                                ...
                                />
                                <img
                                    src="assets/images/outdoor/gambar 4 sansevieria.png"
                                    alt="Gambar 4"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                                <div class="mt-3 text-bold">
                        ...
                        <div class="text-center">
                            ...
                            >
                                ...
                                />
                                <img
                                    src="assets/images/outdoor/gambar 6 calathea.png"
                                    alt="Gambar 6"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                                <div class="mt-3 text-bold">
                        ...
                        <div class="text-center">
                            ...
                            >
                                ...
                                />
                                <img
                                    src="assets/images/outdoor/gambar 7 cloropythum.png"
                                    alt="Gambar 7"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                                <div class="mt-3 text-bold">
                        ...
                        <div class="text-center">
                            ...
                            >
                                ...
                                />
                                <img
                                    src="assets/images/outdoor/gambar 8 diefenbacia.png"
                                    alt="Gambar 8"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                                <div class="mt-3 text-bold">
        ...
        >
            ...
            <div class="px-2 mt-1">
                Tambahkan beberapa tanaman hias dalam ruangan untuk sudut rumah
                <div class="px-2 mt-1">
                    jadi lebih asri. Selain memberikan kesan segar dan tidak
                    monoton pada
                    <div class="px-2 mt-1">
                        ruangan, serta memberikan dampak positif bagi kesehatan.
                    </div>
                    <br />
                    <div class="grid grid-cols-3 gap-4 mt-4">
                        <div class="text-center">
                            ...
                            >
                                <img
                                    src="assets/icons/indoor.png"
                                    alt="Icon"
                                    class="absolute w-20 h-20 -ml-4 -mt-3"
                                />
                                <img
                                    src="assets/images/indoor/gambar 1 alocasia.png"
                                    alt="Gambar 1"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                                <div class="mt-3 text-bold">
                        ...
                        <div class="text-center">
                            ...
                            >
                                ...
                                />
                                <img
                                    src="assets/images/indoor/gambar 2 spathyphillum.png"
                                    alt="Gambar 2"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                                <div class="mt-3 text-bold">
                        ...
                        <div class="text-center">
                            ...
                            >
                                ...
                                />
                                <img
                                    src="assets/images/indoor/gambar 3 anthurium.png"
                                    alt="Gambar 3"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                                <div class="mt-3 text-bold">
                        ...
                        <div class="text-center">
                            ...
                            >
                                ...
                                />
                                <img
                                    src="assets/images/indoor/gambar 5 maranta.png"
                                    alt="Gambar 5"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                                <div class="mt-3 text-bold">
                        ...
                        <div class="text-center">
                            ...
                            >
                                ...
                                />
                                <img
                                    src="assets/images/indoor/gambar 6 diefenbacia.png"
                                    alt="Gambar 6"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                                <div class="mt-3 text-bold">
                        ...
                        <div class="text-center">
                            ...
                            >
                                ...
                                />
                                <img
                                    src="assets/images/indoor/gambar 7 goeppertia.png"
                                    alt="Gambar 7"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                                <div class="mt-3 text-bold">
                        ...
                        <div class="text-center">
                            ...
                            >
                                ...
                                />
                                <img
                                    src="assets/images/indoor/gambar 8 watermelon.png"
                                    alt="Gambar 8"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                                <div class="mt-3 text-bold">
                        ...
                        <div class="text-center">
                            ...
                            >
                                ...
                                />
                                <img
                                    src="assets/images/indoor/gambar 9 croton.png"
                                    alt="Gambar 9"
                                    class="w-48 h-48 mx-auto -mt-1 object-scale-down"
                                />
                                <div class="mt-3 text-bold">
        ...
        <div class="font-semibold w-5/6 mx-auto text-center">
            ...
            <div
                class="mx-auto max-w-[1340px] px-4 sm:px-6 lg:me-0 p-10 lg:pe-0 lg:ps-8"
            >
                <div
                ...
                <div class="-mx-6 mt-8 lg:col-span-2 lg:mx-0">
                    <div id="keen-slider" class="keen-slider">
                        <div class="keen-slider__slide">
                            ...
                            >
                                <blockquote
                                    class="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8 text-left"
                                >
                                    <div class="flex items-center gap-4">
                                        <img
                                            alt="Customer 1"
                                            src="assets/images/tamu/customer1.jpg"
                                            class="size-14 rounded-full object-cover"
                                        />

                                        <div>
                                            <div
                                                class="flex justify-start gap-0.5 text-green-500"
                                            >
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    class="h-5 w-5"
                            ...
                            >
                                ...
                                >
                                    <div class="flex items-center gap-4">
                                        <img
                                            alt="Customer 2"
                                            src="assets/images/tamu/customer2.jpg"
                                            class="size-14 rounded-full object-cover"
                                        />
                            ...
                            >
                                ...
                                >
                                    <div class="flex items-center gap-4">
                                        <img
                                            alt="Customer 3"
                                            src="assets/images/tamu/customer3.jpg"
                                            class="size-14 rounded-full object-cover"
                                        />
        ...
        <div class="font-semibold pb-2 w-8/9 mx-auto text-center -mt-3">
            ...
            <h1
                class="text-center font-semibold text-4xl mb-6 pt-5 text-slate-50"
            ></h1>
            <div class="grid grid-cols-2 gap-4">
                <div
                    class="bg-green-800 w-4/5 mx-auto h-full rounded-xl p-7 text-serif text-white"
                >
                    <h1 class="text-left text-slate-50 font-bold text-4xl">
                        Contact Us
                    </h1>
                    <p class="text-left text-white font-bold text-2xl mt-10">
                        Info Kontak
                    </p>
                    <p class="text-left text-white font-serifbold text-xl mt-2">
                        Senin - Selasa : 09.00 s/d 22.00
                    </p>
                    <p class="text-left text-white font-serifbold text-xl mt-1">
                        Rabu - Jum'at : 12.00 s/d 20.00
                    </p>
                    <p class="text-left text-white font-serifbold text-xl mt-1">
                        Sabtu : 15.00 s/d 21.00
                    </p>
                    <p
                        class="text-left text-white font-serifbold text-xl mt-1 mb-20"
                    >
                        Minggu : Tutup
                    </p>
                    <div class="flex my-3">
                        <img
                            src="./assets/icons/lokasi.png"
                            alt=""
                            class="size-8 bg-green-300 rounded-full"
                        />
                        <h1 class="text-xl text-white mx-3">
                    ...
                    <div class="flex my-3">
                        ...
                        />
                        <h1 class="text-xl text-white mx-3">
                            Email : Lushtilfy@gmail.com
                        </h1>
                    </div>
                </div>
                <img
                    src="./assets/images/tamu/banner1.jpg"
                    alt=""
                    class="w-4/5 mx-auto h-full rounded-xl"
                />
            </div>
            <br /><br /><br />
        </div>
