...
<body class="bg-[#618264] h-screen">
    ...
    <div class="container p-0 mt-4 mb-8">
            ...
            <div class="row-span-3 col-span-2">
                <div class="grid grid-cols-2 gap-4 -ml-44 mt-4">
                    ...
                    <div class="col-span-1">
                        ...
                        <input type="text" class="form-control w-11/12 rounded-lg border-slate-950 mt-1"
                            name="nama_pengguna" readonly value="Vanziix">
                    </div>
                    <div class="col-span-1 -ml-3">
                        <label class="form-label text-lg font-semibold " style="color: #03045E">Nomor HP</label>
                        <input type="number" class="form-control w-8/12 rounded-lg border-slate-950 mt-1 "
                            name="nomor_hp" readonly value="089450219878">
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" class="form-control w-10/12 rounded-lg border-slate-950 mt-1"
                            name="nama_lengkap" readonly value="Rahya Sartakhya Sanjaya">
                    </div>
        ...
        <div class="grid grid-cols-4 gap-4 mt-32">
            <div class="">
                <a class="btn fs-4 font-bold w-4/5 ml-28 h-16 text-2xl"
            ...
            <div class="">
                <a class="btn fs-4 font-bold w-full ml-20 h-16 text-2xl"
                    style="border: 3px solid #0077B6; color: #0077B6" href="ubah_pengaturan_akun_pembeli"
