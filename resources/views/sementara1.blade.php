...
<body class="bg-[#6D896B] h-full">
    ...
    <div class="font-semibold pb-2 w-5/6 mx-auto text-center -mt-3">
        ...
        <div class="flex justify-center mt-2">
            <a href="#outdoor" class="ml-20 mr-auto text-center">
                <!-- Untuk gambar 1 -->
                <div class="bg-gray-100 shadow-lg rounded-lg custom-card-size shadow-card"
                    style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                    <img src=" assets/images/outdoor/gambar 9 goeppertia.png" alt="Gambar 1"
            ...
            <a href="#populer" class="mx-4 text-center">
                ...
                <div class="bg-gray-100 shadow-lg rounded-lg custom-card-size shadow-card"
                    style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                    <img src=" assets/images/populer/gambar 1 monstera.png" alt="Gambar 2"
                        class="w-64 h-64 mx-auto -mt-1 object-scale-down">
                </div>
            ...
            <a href="#indoor" class="ml-auto mr-20 text-center">
                ...
                <div class="bg-gray-100 shadow-lg rounded-lg custom-card-size"
                    style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                    <img src="assets/images/indoor/gambar 4 calla.png" alt="Gambar 3"
                        class="w-64 h-64 mx-auto -mt-1 object-scale-down">
                </div>
                ...
                <div class="grid grid-cols-3 gap-4 mt-4">
                    <div class="text-center">
                        ...
                        <div class="bg-gray-100 shadow-lg rounded-lg p-4">
                            <img src="assets/images/populer/gambar 1 monstera.png" alt="Gambar 1"
                ...
                <div id="keen-slider" class="keen-slider">
                        ...
                        <blockquote class="flex h-full flex-col justify-between  p-6 shadow-sm sm:p-8 lg:p-12">
                            <blockquote class="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8 text-left">
                                <div class="flex items-center gap-4">
                                    <img alt="Customer 1" src="assets/images/tamu/customer1.jpg"
                    ...
                    <div class="keen-slider__slide">
                        <blockquote class="flex h-full flex-col justify-between p-6 shadow-sm sm:p-8 lg:p-12">
                            <blockquote class="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8 text-left">
                                <div class="flex items-center gap-4">
                                    <img alt="Customer 2" src="assets/images/tamu/customer2.jpg"
                                        class="size-14 rounded-full object-cover" />
                    ...
                    <div class="keen-slider__slide">
                        <blockquote class="flex h-full flex-col justify-between  p-6 shadow-sm sm:p-8 lg:p-12">
                            <blockquote class="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8 text-left">
                                <div class="flex items-center gap-4">
                                    <img alt="Customer 3" src="assets/images/tamu/customer3.jpg"
                                        class="size-14 rounded-full object-cover" />
    ...
    <div class="font-semibold pb-2 w-5/6 mx-auto text-center -mt-3">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="w-4/5 mx-auto h-full rounded-xl p-7 text-serif text-white"
    ...
    <footer class="footer p-10 text-neutral-content w-full"
        style="background-image: linear-gradient(rgba(245, 245, 220, 0.7), rgba(245, 245, 220, 0.7)), url('assets/images/tamu/footer.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;">
...
<html lang="en">
    ...
    <body class="bg-[#618264] h-full pb-5">
        ...
        <div class="flex items-center text-[#B0D9B1] text-2xl">
            ...
            <div
                class="text-2xl font-bold pb-2 border-b-2 border-white w-5/6 mx-auto ml-4 mt-10"
            >
                Pesanan
            </div>
        </div>
        ...
        <div
            class="grid grid-cols-1 grid-flow-row gap-0 border border-white w-5/6 mx-auto mb-10"
        >
            <div
                class="h-20 flex justify-center border text-left text-white pl-2 flex-col relative"
            >
                ...
                <button
                    class="bg-[#00A651] text-white px-8 py-1 rounded absolute top-6 right-3"
                >
                    Cetak Resi
                </button>
            </div>
            ...
            <div class="h-80 flex items-center justify-center border relative">
                <div
                    class="text-white text-lg absolute top-3 left-10 text-left flex items-center"
                >
                    <img
                        src="assets/images/outdoor/gambar 5 monstera.png"
                        class="w-32 h-32 mr-5 pl-2"
                    />
                    <div>
                ...
                <div
                    class="text-white text-lg absolute top-12 right-10 text-right"
                >
                    <p>x1</p>
                    <p>Rp. 165.000</p>
                </div>
                <hr
                    class="w-11/12 border-t border-gray-300 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
                />
                <div
                    class="text-white text-lg absolute bottom-5 left-10 text-left flex items-center"
                >
                    <img
                ...
                <div
                    class="text-white text-lg absolute bottom-12 right-10 text-right"
                >
                    <p>x1</p>
                    <p>Rp. 200.000</p>
                </div>
            ...
            <div
                class="h-14 flex justify-between border text-white pl-2 flex-col relative"
            >
