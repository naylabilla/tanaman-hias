...
<body class="bg-[#618264] h-screen ">
    <div class="navbar bg-[#B0D9B1] fixed top-0 rounded-b-3xl grid grid-cols-3 text-black text-3xl font-bold">
        <a href="" class="btn btn-ghost text-xl me-auto">
            <img src="./assets/icon/user.png" alt="" class="w-10">
            <p>Admin</p>
        </a>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="">
                    ...
                    <input
                        ...
                        id="nama" type="text" placeholder="" name="nama" required>
                </div>
                <div class="">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="nama">
                        Stok
                    ...
                    <input
                        ...
                        id="nama" type="number" placeholder="" name="nama" required>
                </div>
                <div class="">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="nama">
                        Tinggi
                ...
                <div class="col-span-2">
                    ...
                    <input
                        ...
                        id="nama" type="file" placeholder="" name="nama" required>
                </div>
                <div class="flex justify-center items-center ">
                    
                    <input type="submit" value="Simpan" class="btn text-white font-bold w-44 text-lg  "
                    style="background-color: #618264 ">
                    
                    
                </div>
                <div class="flex justify-center items-center ">
                    <input type="submit" value="Kembali" class="btn text-white font-bold w-44 text-lg  "
