<!DOCTYPE html>
    ...
    <!-- Navbar -->
    <body class="h-full pb-5 -mt-10" style="background-image: url('{{ asset('assets/images/tamu/bg.png') }}'); background-size: contain; background-position: center;">
    <!-- <div class="navbar bg-white sticky top-0 grid grid-cols-2 text-black text-3xl font-bold" style="
        ...
        <a href="{{ route('rekapan.index')}}" class="flex items-center">
        ...
        <div class="flex font-bold mx-10 mt-4">
            ...
            <div class="col-span-1 ml-28 mt-8">
                    ...
                    <textarea class="w-full bg-white text-black resize-none border border-4 border-green-400" name="pesan" id="" rows="1.5" readonly>{{ $pesananGroup->first()->resi->pesan }}</textarea>
