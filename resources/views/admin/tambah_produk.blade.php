...
<html lang="en">
    ...
    <body class="bg-[#618264] h-screen">
        <div
            class="navbar bg-[#B0D9B1] fixed top-0 rounded-b-3xl grid grid-cols-3 text-black text-3xl font-bold"
        >
            <a
                href="{{ route('dashboard') }}"
                class="btn btn-ghost text-xl me-auto"
            >
        ...
        <div class="fixed left-0 top-[5.5rem] h-screen bg-[#B0D9B1] w-[23%]">
            <div
                class="bg-transparent w-48 min-h-48 rounded-lg flex mx-auto my-5"
            >
                <img
            ...
            <div class="flex justify-center grid grid-rows-3 gap-5">
                ...
                <a
                    href="/pesanan_penjual"
                    class="btn bg-[#B0D9B1] font-bold text-black text-2xl border-none w-72 rounded-full hover:bg-[#27603F] flex items-center gap-4"
                >
                    <img
                        src="/assets/icons/rekapan.png"
                        alt=""
                        class="w-9 h-9 mr-4"
                    />
        ...
        {{-- PRODUK --}}
        <div
            class="rounded-lg absolute top-[5.5rem] ml-[25%] mr-6 bg-[#D0E7D2] w-[73.5%] h-[82%]"
        >
            @if ($errors->any())
            <div class="pt-2">
                <div
                    class="alert alert-danger w-3/4 ml-4 bg-red-500 text-white"
                >
                    <ul>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="flex justify-center items-center mt-4">
                        <input
                            type="submit"
                            value="Simpan"
                            class="btn text-white font-bold w-44 text-lg"
