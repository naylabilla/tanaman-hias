...
<body class="bg-[#618264] h-screen">
    <div class="navbar bg-[#B0D9B1] fixed top-0 rounded-b-3xl grid grid-cols-3 text-black text-3xl font-bold">
        ...
        <a href="/logout" class="btn btn-ghost ms-auto">
            <img src="./assets/icons/logout.png" alt="" class="w-10">
        </a>
    </div>
    <div class="fixed left-0 top-[5.5rem] h-screen bg-[#B0D9B1] w-[23%]">
        <div class="bg-transparent w-64 min-h-64 rounded-lg flex mx-auto my-6">
            <img src="./assets/images/tamu/logo.png" alt="" class="resize pl-1">
        </div>
        <div class="flex justify-center grid grid-rows-3 gap-5">
            <a href="/beranda_penjual" class="btn bg-[#B0D9B1] text-black text-2xl border-none w-72 rounded-full hover:bg-[#618264] gap-10">
                <img src="./assets/icons/beranda.png" alt="" class="size-10">
                <p>Beranda</p>
            </a>
            <a href="/produk_penjual" class="btn bg-[#B0D9B1] text-black text-2xl border-none w-72 rounded-full hover:bg-[#618264] gap-14">
                <img src="./assets/icons/produk.png" alt="" class="size-10 ml-5">
                <p class="mr-5">Produk</p>
            </a>
            <a href="/pesanan_penjual" class="btn bg-[#618264] text-black text-2xl border-none w-72 rounded-full hover:bg-[#618264] gap-10">
                <img src="./assets/icons/pesanan.png" alt="" class="size-10">
                <p>Rekapan</p>
            </a>
        </div>
    </div>
